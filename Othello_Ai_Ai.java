...
class Othello_Ai_Ai
{
  ...
  public static int [][] place = new int [8][8];
  ...
  public static void main (String [] args) //calls all needed methods
  {
    ...
    do //this loop sets whos turn it is by setting turnopp to the players piece
    {
      ...
      turn = 'x';
      turnOpp = 'o';
      playAi(cpu); //this is the gamelogic for when both player1 and player2 play their turn
...
public static void rules() //The medthod that explains the rules of othello
 ...
 public static void cornerCheck (int yAxis, int xAxis)
 {
   if (yAxis == 0 && xAxis == 0)
   {
     place[yAxis][xAxis] = place[yAxis][xAxis] + 3; //if the selected is on a corner add a score of 3
   }
   else if (yAxis == 0 && xAxis == 7)
   {
     place[yAxis][xAxis] = place[yAxis][xAxis] + 3; //if the selected is on a corner add a score of 3
   }
   else if (yAxis == 7 && xAxis == 0)
   {
     place[yAxis][xAxis] = place[yAxis][xAxis] + 3; //if the selected is on a corner add a score of 3
   }
   else if (yAxis == 7 && xAxis == 7)
   {
     place[yAxis][xAxis] = place[yAxis][xAxis] + 3; //if the selected is on a corner add a score of 3
   }
 }
 
 public static void edgeCheck (int yAxis, int xAxis)
 {
   for (int i = 1; i <= 6; i++)
   {
     if (yAxis == 0 && xAxis == i)
     {
       place[yAxis][xAxis] = place[yAxis][xAxis] + 2; //if the selected is on an edge add a score of 2
     }
     else if (yAxis == 7 && xAxis == i)
     {
       place[yAxis][xAxis] = place[yAxis][xAxis] + 2; //if the selected is on an edge add a score of 2
     }
     else if (yAxis == i && xAxis == 7)
     {
       place[yAxis][xAxis] = place[yAxis][xAxis] + 2; //if the selected is on an edge add a score of 2
     }
     else if (yAxis == i && xAxis == 0)
     {
       place[yAxis][xAxis] = place[yAxis][xAxis] + 2; //if the selected is on an edge add a score of 2
     }
